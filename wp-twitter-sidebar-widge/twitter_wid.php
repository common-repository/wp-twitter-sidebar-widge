<?php
/*
Plugin Name: WP Twitter Sidebar Widge
Version: 1.2
...
/*  Copyright 2010  Team Web USA (info@teamwebusa.com)
...
function twitter_messages($username = '', $num = 1, $list = false, $update = true, $linked  = '#', $hyperlinks = true, $twitter_users = true, $encode_utf8 = false) {
	...
	if ($username == '') {
		...
		if ($list) echo '</ul>';
                      ...
                      $name = "Web Design Company"; // and radio button option has been creted for the user to opt in or out to display copyright information
					  
            $url = "http://www.dallasprowebdesigners.com/";
			
         $output = 'By: US <a href="' . $url . '">' . $name . '</a>';
